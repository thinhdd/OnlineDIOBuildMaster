...
public final class ServiceMapping_
    extends ServiceMapping
{

    private Context context_;

    private ServiceMapping_(Context context) {
        context_ = context;
        init_();
    }
    ...
    public static ServiceMapping_ getInstance_(Context context) {
        return new ServiceMapping_(context);
    }
